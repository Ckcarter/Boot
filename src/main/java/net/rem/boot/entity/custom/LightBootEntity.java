...
public class LightBootEntity extends ThrowableItemProjectile {
    public LightBootEntity(EntityType<? extends LightBootEntity> entityType, Level level) {
        super(entityType, level);
    }

    public LightBootEntity(Level level, LivingEntity shooter) {
        super(BootMod.FIREBALL_ENTITY.get(), shooter, level);
    }

    public LightBootEntity(Level level, double x, double y, double z) {
        super(BootMod.FIREBALL_ENTITY.get(), x, y, z, level);
    }

    @Override
    protected Item getDefaultItem() {
        return BootMod.LIGHT_BOOT.get();
    }
